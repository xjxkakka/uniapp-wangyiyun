...
/***/ 12:
/*!******************************************************!*\
  !*** D:/HBProjects/neteaseMusic/common/iconfont.css ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function topList(url) {
  return $http(url);
}

function rankingList(id) {
  return $http("/playlist/detail?id=".concat(id, "&cookie=").concat(cookie), 'get');
}

// 歌曲详情
function songDetail(id) {
  return $http("/song/detail?ids=".concat(id, "&cookie=").concat(cookie), 'get');
}

// 相似歌曲
function songSimi(songId) {
  return $http("/simi/song?id=".concat(songId, "&cookie=").concat(cookie), 'get');
}

// 歌曲评论
function songComment(songId) {
  return $http("/comment/music?id=".concat(songId, "&cookie=").concat(cookie), 'get');
}

// 歌词
function songLyric(songId) {
  return $http("/lyric?id=".concat(songId, "&cookie=").concat(cookie), 'get');
}

// 歌曲所有信息 音频
function songUrl(songId) {
  return $http("/song/url?id=".concat(songId, "&cookie=").concat(cookie), 'get');
}
...
function searchWord(word) {
  return $http("/search?keywords=".concat(word), 'get');
}

// 搜索建议
function searchSuggest(word) {
  return $http("/search/suggest?keywords=".concat(word, "&type=mobile"), 'get');
}
...
/***/ 5:
/*!*********************************************!*\
  !*** D:/HBProjects/neteaseMusic/pages.json ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 51:
/*!*************************************************!*\
  !*** D:/HBProjects/neteaseMusic/store/index.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    LAST_ID: function LAST_ID(state, payload) {
